...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2023-01-26T21:19:27.261Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        code: 'robust scale',
        date: '2023-01-27T14:02:28.314Z',
        details: 'withdrawal sensor',
        status: 'PAID',
        paymentMethod: 'CREDIT_CARD',
        paymentDate: '2023-01-26T19:46:28.996Z',
        paymentAmount: 16937,
      },
    }).then(({ body }) => {
      invoice = body;
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-01-26T22:45').blur().should('have.value', '2023-01-26T22:45');
