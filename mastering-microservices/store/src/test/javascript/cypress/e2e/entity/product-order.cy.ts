...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2023-01-27T02:47:26.772Z', status: 'PENDING', code: 'Grocery', customer: 'Utah Dinar' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-01-27T12:06').blur().should('have.value', '2023-01-27T12:06');
