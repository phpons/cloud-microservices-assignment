...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2023-01-27T14:22:28.457Z',
    sentDate: '2023-01-27T14:49:31.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-26T21:51').blur().should('have.value', '2023-01-26T21:51');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2023-01-27T07:30').blur().should('have.value', '2023-01-27T07:30');
