...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    ...
    date: '2023-01-27T13:27:40.347Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2023-01-27T16:41:25.969Z',
    paymentAmount: 88901,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-01-27T14:35').blur().should('have.value', '2023-01-27T14:35');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-01-27T06:43').blur().should('have.value', '2023-01-27T06:43');
