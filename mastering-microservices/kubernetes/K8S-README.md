...
```
$ docker image tag gateway rlycoolidiswear/gateway
$ docker push rlycoolidiswear/gateway
$ docker image tag invoice rlycoolidiswear/invoice
$ docker push rlycoolidiswear/invoice
$ docker image tag notification rlycoolidiswear/notification
$ docker push rlycoolidiswear/notification
$ docker image tag productorder rlycoolidiswear/productorder
$ docker push rlycoolidiswear/productorder
```
